...
<%@include file="common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>头像：</strong><img src="/statics/fileUpload/${user.picPath}" width="200" height="200"></p>
<%--            <p><strong>工作照：</strong><img src="/statics/fileUpload/${user.workPicPath}" width="200" height="200"></p>--%>
